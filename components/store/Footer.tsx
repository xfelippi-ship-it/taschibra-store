    ...
    <footer className="bg-green-950 text-white mt-16 px-12 pt-14 pb-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/seguranca" style={{color:'rgba(255,255,255,0.75)', fontSize:'13px', textDecoration:'none'}}>Seguranca</a></li>
            <li><a href="/termos" style={{color:'rgba(255,255,255,0.75)', fontSize:'13px', textDecoration:'none'}}>Termos de Uso</a></li>
            <li><a href="/trocas-devolucoes" style={{color:'rgba(255,255,255,0.75)', fontSize:'13px', textDecoration:'none'}}>Trocas e Devolucoes</a></li>
      ...
      <div className="max-w-7xl mx-auto" style={{borderTop:'1px solid #1a4a2a', padding:'20px 0 0'}}>
        <div style={{display:'flex', gap:'24px', marginBottom:'16px', flexWrap:'wrap'}}>
          <a href="/fale-conosco" style={{color:'rgba(255,255,255,0.75)', fontSize:'12px', textDecoration:'none'}}>Atendimento</a>
          <a href="/seguranca" style={{color:'rgba(255,255,255,0.75)', fontSize:'12px', textDecoration:'none'}}>Compra Segura</a>
          <a href="/faq" style={{color:'rgba(255,255,255,0.75)', fontSize:'12px', textDecoration:'none'}}>Perguntas Frequentes</a>
          <a href="/trocas-devolucoes" style={{color:'rgba(255,255,255,0.75)', fontSize:'12px', textDecoration:'none'}}>Politica de Entrega</a>
          <span style={{color:'rgba(255,255,255,0.75)', fontSize:'12px'}}>📞 {telefone}</span>
        </div>
        ...
        <div style={{borderTop:'1px solid #1a4a2a', padding:'16px 0', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'8px'}}>
          ...
          <div style={{display:'flex', gap:'16px'}}>
            <a href="/privacidade" style={{color:'rgba(255,255,255,0.75)', fontSize:'12px', textDecoration:'none'}}>Politica de Privacidade</a>
