...
const TODOS_MODULOS = [
  ...
  { id: 'badges',          label: 'Badges',                grupo: 'Catálogo' },
  ...
  { id: 'promo-banner',    label: 'Banner Promo',          grupo: 'Marketing' },
  { id: 'popup',           label: 'Popup Promocional',     grupo: 'Marketing' },
  { id: 'midias',          label: 'Mídias Sociais',        grupo: 'Marketing' },
  { id: 'blog',            label: 'Blog e Guias',          grupo: 'Marketing' },
  { id: 'retirada',        label: 'Retirada na Loja',      grupo: 'Loja' },
  { id: 'faturamento',     label: 'Faturamento Direto',    grupo: 'Loja' },
  { id: 'beneficios',      label: 'Barra Benefícios',      grupo: 'Loja' },
  { id: 'cms',             label: 'Páginas e Blocos',      grupo: 'Loja' },
