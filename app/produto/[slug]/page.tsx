    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-8 md:grid md:grid-cols-2 md:gap-16 md:items-start pb-24 md:pb-8">
        ...
        <div className="mb-4 md:mb-0">
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden mb-3 flex items-center justify-center" style={{ height: "clamp(280px, 45vw, 520px)", width: "clamp(280px, 45vw, 520px)" }}>
            {imagens.length > 0
